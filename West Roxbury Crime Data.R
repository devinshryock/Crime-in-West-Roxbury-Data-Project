...
boxplot(west.roxbury.crime$Lat,main ="Latitude of Crime in West Roxbury",col="green")
outliers.lat <- boxplot.stats(west.roxbury.crime$Lat)$out

#Plot crime longitudes using boxplot to indentify outliers
boxplot(west.roxbury.crime$Long,main = "Longitude of Crime in West Roxbury", col="red")
...
#Plot k-values to determine where the elbow "breaks".  This is the point where the 
#error stops decreasing as much.  This is the optimal number of kclusters
plot(k.values)
